...
```
$ git clone https://github.com/victorsemipalatin/sirius_2024.git
```
- Из папки репозитория установить необходимые пакеты:
```
$ python3 -m pip install -r requirements.txt
```
- Перейти в папку code/:
```
$ cd code/
```
- Очистить содержимое папки static:
```
$ cd static/
$ rm *
$ cd ..
...
- загрузить .xlsx файл на сайт, используя форму загрузки  
